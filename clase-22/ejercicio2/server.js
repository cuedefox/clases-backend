...
console.log(`longitud obj original = ${tamanoOrganigrama} longitud obj normalizado = ${tamanoOrganigramaNorm}`);
...
console.log(`longitud obj original = ${tamanoOrganigrama} longitud obj normalizado = ${tamanoOrganigramaNorm} longitud obj denormalizado = ${tamanoOrganigramaDenorm}`);