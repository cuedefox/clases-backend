...
console.log(`long obj original ${JSON.stringify(holding).length}`);
console.log(`long obj normalizado ${JSON.stringify(objNormalizado).length}`);
console.log(`long obj denormalizado ${JSON.stringify(objDenormalizado).length}`);
console.log(`% de compresion: ${Math.round((100 - (JSON.stringify(objNormalizado).length * 100 / JSON.stringify(holding).length)))}%`)